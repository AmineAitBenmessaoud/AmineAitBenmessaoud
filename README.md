...
*  **Software Engineer** — Specialized in **backend engineering**, with professional experience in **C++**, **Java**, **Spring**, **Spring Batch**, and large-scale information systems.
...
* **Languages:** C++, Java, Python, Scala, Haskell, Agda, TypeScript
* **Frameworks:** Spring Boot, Spring Batch, Angular, React
